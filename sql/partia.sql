...
--
-- Host: 114.55.224.246    Database: ry-vue
-- ------------------------------------------------------
...
INSERT INTO `gen_table` VALUES (1,'tb_course','课程管理',NULL,NULL,'Course','crud','element-plus','com.ruoyi.course','course','course','课程管理','dapixiu','0','/','{\"parentMenuId\":0}','admin','2025-04-27 00:54:47','','2025-04-27 18:36:29',NULL),(2,'sys_dept','部门表','','','SysDept','tree','element-plus','com.ruoyi.system','system','dept','部门','ruoyi','0','/','{\"treeCode\":\"dept_id\",\"treeName\":\"dept_name\",\"treeParentCode\":\"parent_id\",\"parentMenuId\":\"\"}','admin','2025-04-27 22:29:32','','2025-04-27 22:33:01',NULL);
...
INSERT INTO `sys_config` VALUES (1,'主框架页-默认皮肤样式名称','sys.index.skinName','skin-purple','Y','admin','2025-04-26 23:31:10','admin','2025-04-27 18:47:27','蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow'),(2,'用户管理-账号初始密码','sys.user.initPassword','123456','Y','admin','2025-04-26 23:31:11','',NULL,'初始化密码 123456'),(3,'主框架页-侧边栏主题','sys.index.sideTheme','theme-dark','Y','admin','2025-04-26 23:31:11','',NULL,'深色主题theme-dark，浅色主题theme-light'),(4,'账号自助-验证码开关','sys.account.captchaEnabled','false','Y','admin','2025-04-26 23:31:11','admin','2025-04-27 18:44:59','是否开启验证码功能（true开启，false关闭）'),(5,'账号自助-是否开启用户注册功能','sys.account.registerUser','true','Y','admin','2025-04-26 23:31:12','admin','2025-04-27 18:47:39','是否开启注册用户功能（true开启，false关闭）'),(6,'用户登录-黑名单列表','sys.login.blackIPList','','Y','admin','2025-04-26 23:31:12','',NULL,'设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
...
INSERT INTO `sys_dict_type` VALUES (1,'用户性别','sys_user_sex','0','admin','2025-04-26 23:30:46','',NULL,'用户性别列表'),(2,'菜单状态','sys_show_hide','0','admin','2025-04-26 23:30:47','',NULL,'菜单状态列表'),(3,'系统开关','sys_normal_disable','0','admin','2025-04-26 23:30:48','',NULL,'系统开关列表'),(4,'任务状态','sys_job_status','0','admin','2025-04-26 23:30:49','',NULL,'任务状态列表'),(5,'任务分组','sys_job_group','0','admin','2025-04-26 23:30:49','',NULL,'任务分组列表'),(6,'系统是否','sys_yes_no','0','admin','2025-04-26 23:30:50','',NULL,'系统是否列表'),(7,'通知类型','sys_notice_type','0','admin','2025-04-26 23:30:52','',NULL,'通知类型列表'),(8,'通知状态','sys_notice_status','0','admin','2025-04-26 23:30:54','',NULL,'通知状态列表'),(9,'操作类型','sys_oper_type','0','admin','2025-04-26 23:30:55','',NULL,'操作类型列表'),(10,'系统状态','sys_common_status','0','admin','2025-04-26 23:30:55','',NULL,'登录状态列表'),(100,'学科','course_subject','0','admin','2025-04-27 17:36:27','admin','2025-04-27 17:37:36','课程学科'),(101,'适用人群','people_crowd','0','admin','2025-04-27 18:33:31','',NULL,'适用人群');
...
INSERT INTO `sys_logininfor` VALUES (1,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-27 21:08:22'),(2,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-27 21:56:51'),(3,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-27 23:08:07');
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2025-04-26 23:25:55','',NULL,'超级管理员'),(2,'普通角色','common',2,'2',1,1,'0','0','admin','2025-04-26 23:25:57','',NULL,'普通角色'),(100,'课研人员','research',3,'1',1,1,'0','0','admin','2025-04-27 16:52:53','',NULL,NULL);
...
INSERT INTO `sys_user` VALUES (1,103,'admin','若依','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-04-27 23:08:07','admin','2025-04-26 23:25:36','','2025-04-27 23:08:07','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-04-26 23:25:38','admin','2025-04-26 23:25:38','',NULL,'测试员'),(100,NULL,'xiaozhi','小智','00','','','0','','$2a$10$3n./jk84R/gIYBIyGJ21SOBxcybDcUggbZKjugViZP/26rp4Zixdm','0','0','127.0.0.1','2025-04-27 17:02:24','admin','2025-04-27 16:54:20','admin','2025-04-27 17:23:05',NULL);
...
-- Dump completed on 2025-04-27 23:56:18
